...
class YOLOv7:
    def __init__(self):
        ...
        # self.coords_pub = rospy.Publisher("/object_coords", Int32MultiArray, queue_size=10)
        ...
        self.mode_sub = rospy.Subscriber("/driving_mode", String, self.callback_mode)
        self.image_sub = rospy.Subscriber("/image_delivery", Image, self.callback_img)
        # self.image_sub = rospy.Subscriber("/carla/ego_vehicle/rgb_right/image", Image, self.callback_img)
