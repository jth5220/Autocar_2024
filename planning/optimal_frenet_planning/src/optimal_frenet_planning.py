...
class OptimalFrenetPlanning():
    def __init__(self):
        ...
        self.location_sub = rospy.Subscriber('/location_corrected', Odometry, self.callback_local_path_planning)
    ...
    def callback_local_path_planning(self, location_msg):
        ...
        candidate_paths, opt_path, is_avoiding, gear = self.path_finder.find_path(self.car_pose, self.obstacles)
