...
class TopicRemap():
    ...
    def _set_ros(self):
        ...
        self.carla_lane_cam_sub = rospy.Subscriber('/carla/ego_vehicle/rgb_front/image', Image, self.callback_ll_cam)
        self.carla_delivery_cam_sub = rospy.Subscriber("/carla/ego_vehicle/rgb_right/image", Image, self.callback_dl_cam)
        self.carla_traffic_cam_sub = rospy.Subscriber('/carla/ego_vehicle/rgb_top/image', Image, self.callback_tl_cam)
        ...
        self.erp_ll_cam_pub = rospy.Publisher('/image/lane', Image, queue_size=10)
        self.erp_dl_cam_pub = rospy.Publisher('/image/delivery', Image, queue_size=10)
        self.erp_tl_cam_pub = rospy.Publisher('/image/traffic', Image, queue_size=10)
        return
    ...
    def callback_ll_cam(self, img_msg):
        self.erp_ll_cam_pub.publish(img_msg)
