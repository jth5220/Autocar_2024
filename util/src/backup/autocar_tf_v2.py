...
from geometry_msgs.msg import PoseStamped, TransformStamped, Quaternion, Point, PoseArray, Pose
...
class MapvizTF(object):
    def __init__(self):
        ...
        self.delivery_spot_utm_pub = rospy.Publisher('/delivery_utm', PoseArray, queue_size=10)
        return
    ...
    def callback_spot(self, spot_pose_array_msg):
        ...
        try:
            ...
            self.delivery_spot_utm_pub.publish(utm_pose_array)
